...
<span class="result">// point</span>
      ...
      <p>14.类的内部所有定义的方法，都是不可枚举的，这与es5不同</p>
      <p><span>15.类和模块的内部，默认就是严格模式，所以不需要使用use strict指定运行模式</span></p>
      <p>16.子类继承父类时，new.target会返回子类</p>
      <h4>2.super关键字</h4>
...
此时的super相当于   A.prototype.constructor.call(this)
      ...
      <p>5.super<span>作为对象时</span>在静态方法中指向父类，在普通方法中指向父类得原型</p>
